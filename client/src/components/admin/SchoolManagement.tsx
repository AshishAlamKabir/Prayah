...
import { School, Building, Upload, Image, Video, FileText, Calendar, Users, MapPin, Phone, Mail, Globe } from "lucide-react";
              ...
              <div>
                ...
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-4">
                  <div className="text-center">
                    ...
                    <p className="text-sm text-gray-600 mb-2">Upload images, documents, or videos</p>
                    <Input
                      type="file"
                      multiple
                      accept="image/*,video/*,.pdf,.doc,.docx"
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-center py-8">
                ...
                <h3 className="text-lg font-semibold text-gray-600 mb-2">Media Gallery</h3>
                <p className="text-gray-500 mb-4">View and manage all uploaded media files from schools and notifications.</p>
                <Button variant="outline">Browse Media Files</Button>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
